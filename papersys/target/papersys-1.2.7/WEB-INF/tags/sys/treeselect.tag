...
<%@ attribute name="expandAll" type="java.lang.Boolean" required="false" description="默认是否展开所有节点"%>
...
<script type="text/javascript">
	$("#${id}Button, #${id}Name").click(function(){
		...
		// 正常打开	
		top.$.jBox.open("iframe:${ctx}/tag/treeselect?url="+encodeURIComponent("${url}")+"&module=${module}&checked=${checked}&extId=${extId}&isAll=${isAll}&expandAll=${expandAll}", "选择${title}", 300, 420, {
