	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right"><%--
					<li><a href="#" target="_blank" title="访问系统主页"><i class="icon-home"></i></a></li>--%>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2016-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')}<!--  - Powered By <a href="http://www.chuanshitech.com/" target="_blank">Chuanshi</a> ${fns:getConfig('version')} -->
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
